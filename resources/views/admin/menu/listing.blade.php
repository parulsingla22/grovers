                            ...
                            <div id="sample_editable_1_wrapper" class="">
                                <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                    ...
                                    <tr role="row">
                                        ...
                                        <td>{{ $menu->active}}</td>
                                        <td>
											<form action='menu/{{$menu->id}}/edit' method="get">
												<meta name="csrf-token" content="{{ csrf_token() }}">
												<button type="submit" class="updateRecord" data-id="{{ $menu->id }}" >Update</button>
											</form>
                                        </td>
                                        <td>
											<meta name="csrf-token" content="{{ csrf_token() }}">
                                            <button class="deleteRecord" data-id="{{ $menu->id }}" >Delete</button>
                                        </td>
                                    </tr>
									@endforeach
                                    </tbody>
