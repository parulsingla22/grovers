...
class CartServiceProvider extends ServiceProvider {
	...
	public function register()
	{
		...
		$this->app->bind('cart', 'Darryldecode\Cart\Cart');

        $config = __DIR__ . '/config/config.php';
        $this->mergeConfigFrom($config, 'shopping_cart');

        $this->publishes([__DIR__ . '/config/cart.php' => config_path('shopping_cart.php')], 'config');
