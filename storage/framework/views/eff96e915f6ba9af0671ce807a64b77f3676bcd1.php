...
<?php $__env->startSection('content'); ?>
	...
	<script>							
			$('#butsave').on('click', function(){
				...
				$.ajax({
						url: "<?php echo e(route('features.store')); ?>",
						type: "Post",
						data: formData,
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\grovers\resources\views/admin/features/create.blade.php ENDPATH**/ ?>