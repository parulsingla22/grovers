                    ...
                    <div class="panel panel-default filterable">
                        <div class="panel-heading clearfix">
                            <div class="panel-title pull-left">
                                    <div class="caption">
                                        <i class="livicon" data-name="edit" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Orders Table
                                    </div>
                                </div>
								...
								{{$data->links()}}
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1"
                                            colspan="1" aria-label="
                                                 Member Profile
                                            : activate to sort column ascending">Total
                                        </th>
                                    ...
                                    <tr role="row">
                                        ...
                                        <td>
                                            ...
                                            <button id="deleteRecord" data-id="{{ $order->orderId }}" >Delete</button>
                                        </td>
                                    </tr>
									@endforeach
