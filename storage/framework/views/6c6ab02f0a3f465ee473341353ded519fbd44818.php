...
<body class="skin-josh adminback">
    <header class="header">
        <a href="index.html" class="logo">
            <img src="<?php echo e(URL::asset('adminassets/img/logo.png')); ?>" alt="Logo">
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header ">
                                <img src="<?php echo e(URL::asset('adminassets/img/authors/avatar3.jpg')); ?>" width="90" class="img-circle img-responsive" height="90" alt="User Image" />
                ...
                <div class="page-sidebar  sidebar-nav" id="myDiv">
                    ...
                    <ul id="menu" class="page-sidebar-menu">
						...
						<li class="menu-link">
							...
							<ul class="sub-menu">
								 <li class="menu-link1">
									<a href="<?php echo e(route('features.create')); ?>">
						...
						<li class="menu-link">
							...
							<ul class="sub-menu">
								 <li class="menu-link1">
									<a href="<?php echo e(route('quality.create')); ?>">
										<i class="fa fa-angle-double-right"></i>Add quality
									</a>
								</li>
								</li class="menu-link1">
								<li>
									<a href="<?php echo e(route('quality.index')); ?>">
...
<?php /**PATH C:\xampp\htdocs\laravel\grovers\resources\views/admin/sidebar.blade.php ENDPATH**/ ?>