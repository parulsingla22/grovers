                                ...
                                <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1"
                                            colspan="1" aria-label="
                                                 Points
                                            : activate to sort column ascending">Reference
                                        </th>
										 <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1"
                                            colspan="1" aria-label="
                                                 Points
                                            : activate to sort column ascending">Sub Menu
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="sample_editable_1" rowspan="1"
                                            colspan="1" aria-label="
                                                 Notes
                                    ...
                                    <tr role="row">
                                        ...
                                        <td><?php echo e($menu->item); ?></td>
                                        <td><?php echo e($menu->ref); ?></td>
										<td><?php echo e($menu->menuid); ?></td>
                                        <td><?php echo e($menu->active); ?></td>
                                        <td>
											<form action='menu/<?php echo e($menu->id); ?>/edit' method="get">
												<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
												<button type="submit" class="updateRecord" data-id="<?php echo e($menu->id); ?>" >Update</button>
											</form>
                                        </td>
                                        <td>
											<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
                                            <button class="deleteRecord" data-id="<?php echo e($menu->id); ?>" >Delete</button>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\grovers\resources\views/admin/menu/listing.blade.php ENDPATH**/ ?>