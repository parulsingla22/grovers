                        ...
                        <div class="panel-body">
                            <div id="sample_editable_1_wrapper" class="">
                                <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                    ...
                                    <tbody>
									<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscribe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr role="row">
                                        <td><?php echo e($subscribe->id); ?></td>
                                        <td><?php echo e($subscribe->emailid); ?></td>
                                        <td><?php echo e($subscribe->active); ?></td>
                                        <td>
											<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
                                            <button id="deleteRecord" data-id="<?php echo e($subscribe->id); ?>" >Delete</button>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\grovers\resources\views/admin/subscribers/listing.blade.php ENDPATH**/ ?>