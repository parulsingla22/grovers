                            ...
                            <div id="sample_editable_1_wrapper" class="">
                                <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                    ...
                                    <tr role="row">
										...
										<td><img src="<?php echo e(URL::asset('images/category/')); ?>/<?php echo e($test->img); ?>" alt="Image" width="70px" height="70px" /></td>
                                        <td><?php echo e($test->active); ?></td>
                                        <td>
											<form action='category/<?php echo e($test->id); ?>/edit' method="get">
												<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
												<button type="submit" class="updateRecord" data-id="<?php echo e($test->id); ?>" >Update</button>
											</form>
                                        </td>
                                        <td>
											<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
                                            <button class="deleteRecord" data-id="<?php echo e($test->id); ?>" >Delete</button>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\grovers\resources\views/admin/category/listing.blade.php ENDPATH**/ ?>