...
use Darryldecode\Cart\Exceptions\CartAlreadyStoredException;
...
class Cart
{
     ...
     */
    public function add($id, $name = null, $price = null,$productimg = null, $quantity = null, $attributes = array(), $conditions = array(), $associatedModel = null)
    {
