                        ...
                        <div class="panel-body">
                            <div id="sample_editable_1_wrapper" class="">
                                <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                    ...
                                    <tr role="row">
                                        <td>{{ $test->id }}</td>
                                        <td>{{ $test->porttitle }}</td>
										<td><img src="{{URL::asset('assetfront/images/photos')}}/{{$test->portimage}}" alt="Image" width="70px" height="70px" /></td>
                                        <td>{{$test->portdes}}</td>
										<td>{{ $test->porttype }}</td>
                                        <td>{{ $test->active}}</td>
                                        <td>
											<form action='portfolio/{{$test->id}}/edit' method="get">
