		...
		@foreach($products as $product)
    		...
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="{{URL::asset('images/products/')}}/{{$product->productimg}}" class="image-popup"><img src="{{URL::asset('images/products/')}}/{{$product->productimg}}" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
          	...
          	<p>
				<form method="POST" id="form1{{$product->id}}" action="{{route('cart.add')}}" >
					...
					<a href="#" onclick="document.getElementById('form1{{$product->id}}').submit();" class="btn btn-black py-3 px-5""><span>Add to Cart</a>
				</form>
