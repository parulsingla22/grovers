...
@section('pagelevel')
    ...
    <link href="{{ URL::asset('adminassets/vendors/summernote/summernote.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('adminassets/vendors/jasny-bootstrap/css/jasny-bootstrap.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('adminassets/vendors/select2/css/select2.min.css')}}" rel="stylesheet">
    <link href="{{ URL::asset('adminassets/vendors/select2/css/select2-bootstrap.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{ URL::asset('adminassets/css/pages/blog.css')}}" />
...
@section('content')
    ...
    <!--new blog-->
    <script type="text/javascript" src="{{ URL::asset('adminassets/vendors/summernote/summernote.min.js')}}"></script>
    <script type="text/javascript" src="{{ URL::asset('adminassets/vendors/jasny-bootstrap/js/jasny-bootstrap.js')}}"></script>
    <script type="text/javascript" src="{{ URL::asset('adminassets/vendors/select2/js/select2.js')}}"></script>
    <script type="text/javascript" src="{{ URL::asset('adminassets/js/pages/add_newblog.js')}}"></script>
