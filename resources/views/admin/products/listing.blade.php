                        ...
                        <div class="panel-body table-responsive">
								...
								{{$data->links()}}
                                    ...
                                    <tr role="row">
                                        <td>{{ $product->id }}</td>
                                        <td>{{ $product->name }}</td>
										<td><img src="{{URL::asset('images/products/')}}/{{$product->productimg}}" alt="This is an image" width="50px" height="50px"/></td>
                                        <td>{{ $product->price }}</td>
                                        ...
                                        <td>
											<form action='products/{{$product->id}}/edit' method="get">
												...
												<button type="submit" class="updateRecord" data-id="{{ $product->id }}" >Update</button>
											</form>
                                        </td>
                                        <td>
											<meta name="csrf-token" content="{{ csrf_token() }}">
                                            <button class="deleteRecord" data-id="{{ $product->id }}" >Delete</button>
                                        </td>
                                    </tr>
									@endforeach
